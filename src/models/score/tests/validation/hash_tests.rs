...
mod tests {
    ...
    #[test]
    fn test_hash_validation_valid_alphanumeric() {
        let score = ScoreRow {
            id: 1,
            user_id: 12345,
            beatmap_id: 67890,
    ...
    #[test]
    fn test_hash_validation_valid_single_character() {
        let score = ScoreRow {
            id: 1,
            user_id: 12345,
            beatmap_id: 67890,
    ...
    #[test]
    fn test_hash_validation_invalid_empty() {
        let score = ScoreRow {
            id: 1,
            user_id: 12345,
            beatmap_id: 67890,
    ...
    #[test]
    fn test_hash_validation_invalid_too_long() {
    ...
    #[test]
    fn test_hash_validation_invalid_with_special_characters() {
        let score = ScoreRow {
            id: 1,
            user_id: 12345,
            beatmap_id: 67890,
